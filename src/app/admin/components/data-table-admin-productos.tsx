...
const createColumns = (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (precios.length === 0)
        return <div className="text-right text-sm md:text-base">N/A</div>;
...
export function DataTableProductos({
  data,
  onProductoActualizado,
}: DataTableProductosProps) {
    ...
    <div className="w-full">
              ...
              .map((column) => {
                return (
                  ...
                  >
                    {column.id === "actions"
                      ? "Acciones"
                      : column.id === "precio_base"
                      ? "Precio Base"
                      : column.id === "rango_precios"
                      ? "Rango Precios"
                      : column.id === "tamanos_disponibles"
                      ? "Tamaños"
                      : column.id === "descripcion"
                      ? "Descripción"
                      : column.id === "ingredientes"
                      ? "Ingredientes"
                      : column.id === "opciones"
                      ? "Opciones"
                      : column.id === "activo"
                      ? "Estado"
                      : column.id === "categoria.nombre"
                      ? "Categoría"
                      : column.id}
                  </DropdownMenuCheckboxItem>
                );
      ...
      {productoEditando && (
        <ModalEditarProducto
          ...
          onProductoActualizado={handleProductoActualizado} // ← CAMBIADO A "onProductoActualizado"
